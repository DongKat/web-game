...
export class OverlayMap {
    ...
    moveCursor(toCol: number, toRow: number, _flag: {flagName: string, flagValue: any} | null = null): void {
        // TODO: Bound the cursor in movement range when selecting unit to move
